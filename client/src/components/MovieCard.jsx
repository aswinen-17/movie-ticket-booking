...
const MovieCard = ({movie}) => {
  ...
  return (
    ...
    rounded-2xl hover:-translate-y-1 transition duration-300 w-66'>
      ...
      <img onClick={()=>{navigate(`/movies/${movie._id}`); scrollTo(0,0)}} src={image_base_url + movie.backdrop_path} alt="" className='rounded-lg h-52 w-full
      ...
      <div className='flex items-center justify-between mt-4 pb-3'>
        ...
        transition rounded full font-medium cursor-pointer'>Buy Ticket</button>
