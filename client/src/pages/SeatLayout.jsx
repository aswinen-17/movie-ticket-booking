...
const SeatLayout = () => {
  ...
  const handleSeatClick = (seatId) => {
    ...
    if(!selectedSeats.includes(seatId) && selectedSeats.length > 19) {
      return toast ('you can only select 20 seats')
    }
  ...
  return show ? (
    ...
    md:pt-50'>
      {/* Available timing */}
      <div className='w-60 bg-primary/10 border border-primary/20 rounded/20 rounded-lg py-10
