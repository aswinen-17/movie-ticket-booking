    ...
    <>
      ...
      <div className='overflow-x-auto pb-4'>
        ...
        {nowPlayingMovies.map((movie)=>(
          ...
          duration-300`} onClick={()=> setSelectedMovie(movie.id)}>
            <div className='relative rounded_lg overflow-hidden'>
      ...
      <div className='mt-8'>
        ...
        border-gray-600 px-3 py-2 rounded-md'>
          <p className='tet-gray-400 text-sm'>{currency}</p>
      ...
      {/* date & time selection */}
      <div className='mt-6'>
      <label className='block text-sm font-medium mb-2'>Select Date & Time
      </label>
              ...
              <li key={date}>
                ...
                <div className='flex flex-wrap gap-2 mt-1 text-sm'>
                  {times.map((time) => (
                    ...
                    border-primary px-2 py-1 flex items-center
                    rounded'>
                      <span>{time}</span>
